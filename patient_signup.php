...
$sql = "insert into registration values('$name','$age','$phoneno','$usernames','$passwords')";
    ...
    <div class="container mt-5">
        <div class="card w-75 mx-auto">
            ...
            <div style="margin-bottom:10px;margin-left:-5px;border:1px solid black;padding:10px;">
                <a href="patient_signup.php"style="margin-left:-150px;padding-left:150px;padding-right:50px;padding-top:12px;padding-bottom:12px;background-color:green;color:black;list-style-type:none;text-decoration:none;">PATIENT REGISTRATION</a>
                ...
                <p class="mt-3 text-center">Already have an account? <a href="patient_login.php">Login here</a></p>
            </div>
        </div>
    </div>
</div>
