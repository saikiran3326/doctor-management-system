    ...
    $sql = "SELECT * FROM doctor_registration WHERE username = '{$usernames }' AND passwords = '{$passwords}' LIMIT 1";
        ...
        <div class="container mt-5" id="sai">
            <div class="card w-50 mx-auto">
                ...
                <div class="card-body">
                    ...
                    <a href="patient_login.php"style="padding-left:50px;padding-right:50px;list-style-type:none;text-decoration:none;">PATIENT LOGIN</a>
                    <a href="doctor_login.php"style="margin-left:0px;padding-left:100px;padding-right:50px;padding-top:12px;padding-bottom:12px;background-color:blue;color:black;list-style-type:none;text-decoration:none;margin-right:-50px;">DOCTOR LOGIN</a>
                    <br></div>
                    ...
                    <p class="mt-3 text-center">Don't have an account? <a href="doctor_signup.php">Register here</a></p>
                </div>
            </div>
        </div>
    </div>
